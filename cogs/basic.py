...
class Basic(commands.Cog):
    ...
    async def DM(self, ctx):
        ...
        if heroku_check == 'False':
            ...
            embed.add_field(name="**findthebitch**", value="Bakibot will figure out who is a bitch in the server all on his own", inline=False)
            ...
            embed.add_field(name="**pokemon**", value="Highlight a specific Pokemon. This can be either the pokedex number or their name. Just like this: !pickapokemon Mewtwo or !pickapokemon 150", inline=False)
